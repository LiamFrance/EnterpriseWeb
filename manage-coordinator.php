        ...
        $checkdup = mysqli_query($conn, $query);
            if (!$nodup = $checkdup->fetch_assoc()) {          
                ...
                $error = "<br>Can't update user, please try again";
                    ...
                    header("Location:AdminHome.php#coordinator?successfulUpdated");
                }
            }
    }
...
<body>
    ...
    <div class="grid-container">
        ...
        <!-- Right Content -->
        <div class="content">
            <h2>Manage Coordinator Information</h2>
                <form action="manage-coordinator.php" method ="POST" enctype="multipart/form-data">
